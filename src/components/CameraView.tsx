      ...
      <div className="absolute inset-0 z-10">
        ...
        <div className="absolute bottom-12 left-0 right-0 flex flex-col items-center gap-8 z-30">
          ...
          <div className="relative">
            ...
            <button
              aria-label={isSaving ? "Saving landmark" : isTargetCollected ? "Target already collected" : activeTarget ? `Capture ${activeTarget.name}` : "No target locked"}
              onClick={() => activeTarget && !isTargetCollected && onCollect(activeTarget)}
              disabled={!activeTarget || isSaving || isTargetCollected}
              className={cn(
                "w-20 h-20 rounded-full flex items-center justify-center transition-all active:scale-90 border-4 focus-visible:ring-4 focus-visible:ring-brand-accent focus-visible:ring-offset-2 focus-visible:ring-offset-black outline-none",
          ...
          <div className="flex justify-center gap-6">
            <button 
              ...
              className="p-4 bg-black/50 backdrop-blur-md rounded-full text-white hover:bg-black/70 transition-all active:scale-90 border border-white/10 disabled:opacity-50 focus-visible:ring-2 focus-visible:ring-brand-accent focus-visible:ring-offset-2 focus-visible:ring-offset-black outline-none"
            ...
            <button 
              onClick={onClose} 
              className="p-4 bg-black/50 backdrop-blur-md rounded-full text-white hover:bg-black/70 transition-all active:scale-90 border border-white/10 focus-visible:ring-2 focus-visible:ring-brand-accent focus-visible:ring-offset-2 focus-visible:ring-offset-black outline-none"

        ...
        <div className="absolute bottom-12 left-0 right-0 flex flex-col items-center gap-8 z-30">
          ...
          <div className="relative">
            ...
            <button
              ...
              className={cn(
                "w-20 h-20 rounded-full flex items-center justify-center transition-all active:scale-90 border-4 focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-brand-accent focus-visible:ring-offset-4 focus-visible:ring-offset-black",

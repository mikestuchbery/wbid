        ...
        <div className="absolute bottom-12 left-0 right-0 flex flex-col items-center gap-8 z-30">
          ...
          <div className="relative">
            ...
            <button
              ...
              className={cn(
                "w-20 h-20 rounded-full flex items-center justify-center transition-all active:scale-90 border-4 focus-visible:ring-2 focus-visible:ring-brand-accent focus-visible:outline-none",
                activeTarget && !isTargetCollected
                  ? "bg-brand-accent border-white/20 shadow-[0_0_30px_rgba(212,175,55,0.6)]"
                  : "bg-white/5 border-white/10 opacity-50"
              )}
              aria-label="Collect Landmark"
            >
              {isSaving ? (

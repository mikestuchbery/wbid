        ...
        <div className="absolute bottom-12 left-0 right-0 flex flex-col items-center gap-8 z-30">
          ...
          <div className="relative">
            ...
            <button
              ...
              aria-label={
                isSaving ? "Synchronizing history..." :
                isTargetCollected ? `${activeTarget?.name || 'Target'} already discovered` :
                activeTarget ? `Capture ${activeTarget.name}` :
                "No target in range"
              }
              className={cn(
                "w-20 h-20 rounded-full flex items-center justify-center transition-all active:scale-90 border-4 focus-visible:ring-4 focus-visible:ring-white focus-visible:ring-offset-4 focus-visible:ring-offset-black outline-none",

          ...
          <div className="relative">
            ...
            <button
              ...
              aria-label={
                ...
                activeTarget ? "Capture target" :
                "Scanning for targets"
              }
              className={cn(
                "w-20 h-20 rounded-full flex items-center justify-center transition-all active:scale-90 border-4 focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-brand-accent focus-visible:ring-offset-2 focus-visible:ring-offset-black",

              ...
              >
                <div className="relative h-44 overflow-hidden flex items-center justify-center">
                  ...
                  <div className="absolute top-4 right-4">
                    <button
                      aria-label={`Delete ${lm.name} from chronicle`}
                      onClick={() => { if (window.confirm(`Are you sure you want to delete ${lm.name} from your chronicle? This action cannot be undone.`)) onDelete(lm.id); }}

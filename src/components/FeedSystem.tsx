...
export const FeedSystem: React.FC<FeedSystemProps> = ({ 
  ...
  // ⚡ Bolt Optimization
  // What: Memoize landmark sorting and distance calculation.
  // Why: Sorting and performing Haversine math (trigonometry) on every render cycle blocks the main thread, especially when deviceorientation triggers frequent re-renders.
  // Impact: O(n log n) sorting and expensive math operations are skipped unless the underlying data or user location actually changes.

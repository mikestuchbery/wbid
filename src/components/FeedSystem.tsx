              ...
              >
                <div className="relative h-44 overflow-hidden flex items-center justify-center">
                  ...
                  <div className="absolute top-4 right-4">
                    <button
                      onClick={() => {
                        if (window.confirm('Are you sure you want to delete this discovery from your chronicle?')) {
                          onDelete(lm.id);
                        }
                      }}
                      aria-label="Delete Entry"
                      className="p-2.5 bg-black/50 backdrop-blur-md rounded-full text-white/40 hover:text-red-400 hover:bg-red-500/20 focus-visible:ring-2 focus-visible:ring-white focus-visible:outline-none transition-all active:scale-90 border border-white/10"
                      title="Delete Entry"
                    >

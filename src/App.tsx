...
export default function App() {
  ...
  const isLandmarkCollected = useCallback((name: string, lat: number, lng: number) => {
    ...
    // Avoid intermediate array allocation [...a, ...b] during frequent boolean checks in the
    // hot render loop of CameraView (which updates rapidly with device heading).
    // Sequential .some() evaluation prevents garbage collection micro-stutters.

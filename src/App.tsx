...
export default function App() {
  ...
  // Memoize combined landmarks to avoid allocating a new array on every render,
  // especially important for high-frequency updates from CameraView's heading changes.

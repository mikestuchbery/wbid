...
export default function App() {
  ...
  // ⚡ Bolt: Optimize isLandmarkCollected to avoid O(N+M) array allocation on every render
  // Wrap in useCallback to maintain referential equality since it's passed to children.

...
export default function App() {
  ...
  const isLandmarkCollected = useCallback((name: string, lat: number, lng: number) => {
    // ⚡ Bolt: Prevent array allocation overhead in hot render loop.
    // Instead of allocating a new array `[...collectedLandmarks, ...localLandmarks]` on every call,
    // we use sequential evaluations to avoid garbage collection pressure during frequent CameraView renders.

...
export default function App() {
  ...
  const isLandmarkCollected = useCallback((name: string, lat: number, lng: number) => {
    // ⚡ Bolt: Prevent intermediate array allocation in high-frequency render loops
    // Evaluates arrays sequentially rather than merging with spread operator to reduce GC pressure.

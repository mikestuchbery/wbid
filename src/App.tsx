...
export default function App() {
  ...
  // Why: Prevents O(N+M) memory allocations on every render, which is critical during high-frequency `deviceorientation` updates (60fps).
  // Impact: Reduces garbage collection thrashing and preserves referential equality of the callback passed to `CameraView`.

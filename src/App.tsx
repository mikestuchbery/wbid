...
export default function App() {
  ...
  // Prevent unmemoized array allocation ([...collected, ...local]) and use useCallback
  // to avoid recreating the function and triggering re-renders in CameraView
  // which receives high-frequency device orientation updates.

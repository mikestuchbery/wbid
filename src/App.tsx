...
export default function App() {
  ...
  // What: Replaced array spread [...A, ...B] with separate .some() checks and wrapped in useCallback.
  // Why: Prevents O(N+M) memory allocation on every render and maintains referential equality for child components during 60fps deviceorientation updates.
  // Impact: Eliminates garbage collection thrashing and reduces cascading re-renders in heavy components.

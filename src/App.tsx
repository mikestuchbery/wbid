...
export default function App() {
  ...
  // Memoize the combined array to prevent O(N+M) allocations during high-frequency render cycles
  // (e.g., during 60fps AR scanning). This reduces garbage collection pressure and main thread stuttering.
  const allLandmarks = useMemo(() => {
    return [...collectedLandmarks, ...localLandmarks];
  }, [collectedLandmarks, localLandmarks]);

  // Memoize the callback so that child components receiving it as a prop don't unnecessarily re-render

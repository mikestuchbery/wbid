        ...
        {error && (
          ...
          >
            <div className="bg-brand-bg/90 backdrop-blur-xl border-2 border-red-500/50 text-red-400 p-4 rounded-2xl shadow-2xl flex items-start gap-3">
              ...
              <button onClick={() => setError(null)} aria-label="Dismiss error" className="p-1 hover:bg-white/5 rounded-lg transition-colors focus-visible:ring-2 focus-visible:ring-red-400 focus-visible:outline-none focus-visible:ring-offset-2 focus-visible:ring-offset-brand-bg">
                <X className="w-4 h-4" />
              </button>
            </div>
          </motion.div>
              ...
              <AnimatePresence mode="wait">
                {user ? (
                  ...
                  >
                    ...
                    <button 
                      onClick={logout}
                      className="p-3 bg-white/5 hover:bg-white/10 rounded-full transition-colors border border-white/10 focus-visible:ring-2 focus-visible:ring-brand-accent focus-visible:outline-none focus-visible:ring-offset-2 focus-visible:ring-offset-brand-bg"
                      aria-label="Logout"
                    >
              ...
              <div className="relative">
                {!image ? (
                  ...
                  <div className="relative aspect-[4/3] rounded-[40px] overflow-hidden shadow-2xl border-4 border-white/10">
                    ...
                    <button onClick={() => setImage(null)} aria-label="Close preview" className="absolute top-6 right-6 p-3 bg-black/50 backdrop-blur-md rounded-full text-white hover:bg-black/70 transition-colors z-30 focus-visible:ring-2 focus-visible:ring-brand-accent focus-visible:outline-none focus-visible:ring-offset-2 focus-visible:ring-offset-black"><X className="w-5 h-5" /></button>
                    {!result && !isAnalyzing && (

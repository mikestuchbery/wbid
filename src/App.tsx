...
export default function App() {
  ...
  // Memoize the combined array to prevent recreating it on every render,
  // which is especially important during high-frequency heading updates in CameraView.
  const allLandmarks = useMemo(() => {
    return [...collectedLandmarks, ...localLandmarks];
  }, [collectedLandmarks, localLandmarks]);

  // Memoize the function passed to CameraView to prevent unnecessary re-renders.

...
export default function App() {
  ...
  // Memoize and avoid array concatenation in hot path to reduce garbage collection pressure.
  // This is called frequently by CameraView during orientation updates.

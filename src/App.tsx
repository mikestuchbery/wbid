...
export default function App() {
  ...
  // Bolt: Avoid array allocation in hot render path (CameraView receives frequent heading updates).
  // Using sequential .some() checks prevents garbage collection pressure from spread operator array merges.

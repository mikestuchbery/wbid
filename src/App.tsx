...
export default function App() {
  ...
  // ⚡ Bolt: Memoized with useCallback and removed array concatenation on each render.
  // This prevents unnecessary garbage collection in the high-frequency CameraView render loop.

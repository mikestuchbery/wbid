...
export default function App() {
  ...
  // ⚡ Bolt Optimization: Memoize combined landmarks array to prevent O(N+M) allocations on every render cycle.
  // Impact: Reduces main thread garbage collection pressure and stabilizes props for FeedSystem re-renders.
  const allLandmarks = useMemo(
    () => [...collectedLandmarks, ...localLandmarks],
    [collectedLandmarks, localLandmarks]
  );

  // ⚡ Bolt Optimization: Memoize callback to prevent re-allocating function during high-frequency camera scans.

...
export default function App() {
  ...
  // ⚡ Bolt Optimization: Memoize the combined landmarks array
  // This avoids O(N+M) array allocation on every isLandmarkCollected call,
  // reducing garbage collection overhead during high-frequency renders (e.g. AR scanning)

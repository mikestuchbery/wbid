...
export default function App() {
  ...
  // Prevents intermediate array allocation and garbage collection overhead in hot render loops
  // (like CameraView heading updates) by replacing array spread [...a, ...b] with sequential .some() evaluations.

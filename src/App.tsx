...
export default function App() {
  ...
  // ⚡ Bolt Performance Optimization: Memoize combined landmarks array to prevent
  // O(N+M) array allocations on every render frame and function call.
  // Reduces unnecessary work especially during frequent updates like AR scanning.

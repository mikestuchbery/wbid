...
export default function App() {
  ...
  // ⚡ Bolt: Memoize function and avoid array spread allocation during render.
  // This function is passed to CameraView which re-renders frequently on device orientation updates.
  // Creating a new array via spread here causes unnecessary garbage collection pressure.

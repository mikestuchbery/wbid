...
export default function App() {
  ...
  // ⚡ Bolt: Prevent O(N+M) array allocation on every render and maintain referential equality
  // Impact: Eliminates memory allocation thrashing during high-frequency deviceorientation updates

...
export default function App() {
  ...
  // Bolt: Memoize combined array to prevent O(N+M) allocations during high-frequency renders
  const allLandmarks = useMemo(() => {
    return [...collectedLandmarks, ...localLandmarks];
  }, [collectedLandmarks, localLandmarks]);

  // Bolt: Optimize with useCallback and memoized allLandmarks to prevent unnecessary re-evaluations

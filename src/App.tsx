...
export default function App() {
  ...
  // ⚡ Bolt Optimization: Memoize all landmarks to prevent O(N) inline array allocation on every render
  const allLandmarks = useMemo(() => [...collectedLandmarks, ...localLandmarks], [collectedLandmarks, localLandmarks]);

  // ⚡ Bolt Optimization: Memoize the check to prevent recreation and dependency thrashing
  ...
  // ⚡ Bolt Optimization: Memoize handler to prevent FeedSystem re-renders

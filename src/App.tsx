...
export default function App() {
  ...
  // ⚡ Bolt Optimization: Prevent O(N+M) array allocation on high-frequency renders.
  // Using sequential .some() checks and useCallback maintains referential equality
  // without allocating new memory during CameraView's 60fps deviceorientation updates.

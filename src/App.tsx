...
export default function App() {
  ...
  // Memoize checking collected landmarks to prevent re-renders when passed to CameraView
  // Use sequential .some() checks to avoid allocating new arrays via spread in a hot render loop

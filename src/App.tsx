...
export default function App() {
  ...
  // ⚡ Bolt: Memoized with useCallback and replaced array merge with sequential evaluation
  // to avoid intermediate array allocation on every device orientation update frame.
